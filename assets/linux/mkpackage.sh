...
do
    ...
    dir="${dir##*/}"
    echo $dir
    mkdir -p "release/linux/swee++-0.1/usr/share/locale/$dir/LC_MESSAGES"
    msgfmt -o "release/linux/swee++-0.1/usr/share/locale/$dir/LC_MESSAGES/swee++.mo" "locales/$dir/swee++.po"
done
